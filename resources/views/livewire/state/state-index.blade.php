        ...
        <div class="card  mx-auto">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <form>
                            <div class="form-row align-items-center">
                                <div class="col">
                                    <input type="search" wire:model="search" class="form-control mb-2" id="inlineFormInput" placeholder="Dhaka">
                                </div>
                    ...
                    <div>
                        <button wire:click="showStateModal" class="btn btn-primary">New State</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
